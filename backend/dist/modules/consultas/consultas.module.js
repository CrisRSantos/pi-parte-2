...
const medicacao_entity_1 = require("./entities/medicacao.entity");
...
exports.ConsultasModule = ConsultasModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([prontuario_entity_1.Prontuario, medicacao_entity_1.Medicacao])],
    })
], ConsultasModule);
